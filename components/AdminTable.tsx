  ...
  return (
    <div>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((r) => (
                  <tr
                    ...
                    onClick={() => setDetailModal({ open: true, reservation: r })}
                  >
      ...
      <Modal
        ...
        title={`예약 상세 #${detailModal.reservation?.reservation_number ?? ''}`}
        size="md"
      >
        {detailModal.reservation && (() => {
          ...
          return (
            <div className="space-y-4 text-sm">
              ...
              <Button variant="outline" onClick={() => setDetailModal({ open: false, reservation: null })} className="w-full">닫기</Button>
            </div>
          )
        })()}
      </Modal>
